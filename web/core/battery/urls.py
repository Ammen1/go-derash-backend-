...
urlpatterns = [
    ...
    path('user/updatebattery/<int:pk>/',
         UpdateBattery.as_view(), name="updatebattery"),
    # ursl for Brand
    path('user/batterybrand/', CreatBrand.as_view(), name='batterybrand'),
    ...
    path('user/updatebrand/<int:pk>/',
         UpdateBrand.as_view(), name="updatebrand"),

    # urls for Category
    path('user/batterycategory/',
         CreatBatteryCategory.as_view(), name='batterycategory'),
    ...
    path('user/updatecategory/<int:pk>/',
