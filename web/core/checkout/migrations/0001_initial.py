    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999999.99.'}}, help_text='Maximum 999999.99', max_digits=10, verbose_name='delivery price')),
